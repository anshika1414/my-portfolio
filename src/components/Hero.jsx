...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-[90svh] flex flex-col justify-center overflow-hidden bg-transparent"
    >
      <div className="ellipse-glow-left" />
      
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-8 pt-20 pb-8 flex-1">
        ...
        <div className="flex-1 flex flex-col justify-center items-center md:items-start text-center md:text-left h-full md:pl-[12%] lg:pl-[15%]">
          {/* Kicker Line */}
          <div className="flex items-center gap-4 mb-5 animate-fade-in group">
          ...
          <div className="relative w-full mb-6 flex flex-col pointer-events-none">
            <h1 className="flex flex-col">
              <span
                className="leading-[1] animate-slide-up"
                style={{
              ...
              <span
                className="animate-slide-up leading-[1]"
                style={{
          ...
          <p className="max-w-xl text-sm font-normal leading-relaxed text-white/60 mb-8 animate-fade-in lg:text-base pr-4" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="flex flex-row items-center justify-center md:justify-start gap-5 animate-fade-in w-full sm:w-auto" style={{ animationDelay: '0.5s' }}>
            <a
              href="#projects"
              className="px-6 sm:px-8 py-4 border border-white/20 bg-transparent text-[10px] sm:text-xs font-black uppercase tracking-widest text-white hover:bg-white hover:text-cosmic transition-all duration-300"
            >
              View Projects
            </a>
            <a
              href="/resume.pdf"
              download
              className="px-6 sm:px-8 py-4 border border-white/20 bg-transparent text-[10px] sm:text-xs font-black uppercase tracking-widest text-white flex items-center justify-center gap-3 hover:bg-white hover:text-cosmic transition-all duration-300"
            >
        ...
        <div className="hidden md:flex flex-col justify-center animate-fade-in pr-[4%] lg:pr-[6%]" style={{ animationDelay: '0.7s' }}>
          <div className="flex items-center gap-4 px-6 py-4 bg-accent-green/5 border border-accent-green/10 rounded-md backdrop-blur-md">
